            ...
            >
                ...
                <div style={{ textAlign: "center", marginBottom: "64px" }}>
                    ...
                    <p style={{
                        ...
                        Nejsme typická agentura. Kombinujeme rychlost, AI a reálnou zodpovědnost za výsledek.
                    </p>
                </div>

                {/* Two-card grid */}
                <div className="why-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px", alignItems: "stretch" }}>

                    {/* ── PK Digital card (highlighted) ── */}
                    <div
                        style={{
                            position: "relative",
                            borderRadius: "24px",
