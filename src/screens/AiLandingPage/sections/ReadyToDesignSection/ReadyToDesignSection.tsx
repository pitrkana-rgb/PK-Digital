...
const DarkFloatingField = ({
  ...
  const sharedStyle = {
    ...
    border: `1px solid ${focused ? "rgba(0,229,255,0.8)" : error ? "rgba(248,113,113,0.75)" : "rgba(255,255,255,0.12)"}`,
    borderRadius: "16px",
    ...
    boxShadow: focused ? "0 0 0 4px rgba(0,229,255,0.12)" : "none",
  ...
  return (
    <div style={{ position: "relative", display: "flex", flexDirection: "column", gap: "4px" }}>
      <label htmlFor={id} style={{
        ...
        color: focused ? "#00E5FF" : "rgba(255,255,255,0.52)",
      ...
      {isSelect ? (
        <div style={{ position: "relative" }}>
          ...
          >
            ...
            {options?.map((opt) => (
              <option key={opt} value={opt} style={{ background: "#17191c", color: "#ffffff" }}>
                {opt}
              </option>
            ))}
          </select>
          <ChevronDown style={{ position: "absolute", right: "16px", top: "50%", transform: "translateY(-50%)", width: "18px", color: "rgba(255,255,255,0.45)", pointerEvents: "none" }} />
        </div>
      ) : (
        <input
          id={id}
      ...
      {error ? <span style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: "12px", color: "#FCA5A5", paddingLeft: "4px", marginTop: "2px" }}>{error}</span> : null}
    </div>
  );
};
...
export const ReadyToDesignSection = (): JSX.Element => {
  ...
  return (
    <section style={{ width: "100%", backgroundColor: "#ffffff", padding: "80px 0 100px", marginTop: "-50px", marginBottom: "-80px" }}>
      <SectionDivider />
        ...
        <div className="cta-form-wrap" style={{ position: "relative" }}>
          ...
          <div
            ...
            style={{
              ...
              overflow: "hidden",
              boxShadow: "0 24px 60px rgba(2,6,23,0.14)",
            }}
          >
            <div
              aria-hidden="true"
              style={{
                position: "absolute",
                inset: 0,
                background: "radial-gradient(ellipse 60% 70% at 50% 0%, rgba(0,229,255,0.16) 0%, transparent 60%), radial-gradient(ellipse 80% 60% at 10% 120%, rgba(224,64,251,0.14) 0%, transparent 55%)",
                pointerEvents: "none",
                opacity: 0.9,
              }}
            />
            ...
            {submitted ? (
              <div style={{ position: "relative", zIndex: 1, textAlign: "center", padding: "34px 0 12px" }}>
                ...
                <h3 style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: "28px", color: "#ffffff", marginBottom: "12px" }}>
                  {isEn ? "Thank you for your request." : "Děkujeme za odeslání."}
                </h3>
                <p style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: "17px", color: "rgba(255,255,255,0.72)", marginBottom: "32px" }}>
                  {isEn ? "We will get back to you within 24 hours." : "Ozveme se do 24 hodin."}
                </p>
                <button
                  type="button"
                  onClick={() => setSubmitted(false)}
                  style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.16)", color: "#ffffff", padding: "12px 24px", borderRadius: "12px", cursor: "pointer", fontFamily: "'Space Grotesk',sans-serif" }}
                >
              ...
              <form onSubmit={handleSubmit} style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", gap: "24px" }}>
                  ...
                  <div className="cta-form-col" style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                    ...
                    <div ref={featuresDropdownRef} style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                      <button
                        ...
                        style={{
                          background: "rgba(255,255,255,0.06)",
                          border: `1px solid ${featuresOpen ? "rgba(0,229,255,0.8)" : "rgba(255,255,255,0.12)"}`,
                          borderRadius: "16px",
                          minHeight: "58px",
                          padding: "12px 16px",
                          fontFamily: "'Space Grotesk',sans-serif",
                          ...
                          gap: "12px",
                          cursor: "pointer",
                          boxShadow: featuresOpen ? "0 0 0 4px rgba(0,229,255,0.12)" : "none",
                          transition: "all 250ms ease",
                          backdropFilter: "blur(10px)",
                        }}
                      >
                        <span style={{ color: form.features.length ? "#ffffff" : "rgba(255,255,255,0.52)" }}>
                        ...
                        <ChevronDown style={{ width: "18px", color: "rgba(255,255,255,0.45)", transform: featuresOpen ? "rotate(180deg)" : "rotate(0deg)", transition: "transform 200ms ease" }} />
                      </button>
                      {featuresOpen ? (
                        <div
                        ...
                        >
                          {FEATURES.map((opt) => {
                            ...
                            return (
                              <label key={opt} style={{ display: "flex", alignItems: "center", gap: "10px", padding: "6px 8px", borderRadius: "10px", cursor: "pointer", background: checked ? "rgba(0,229,255,0.12)" : "transparent" }}>
                                <input type="checkbox" checked={checked} onChange={() => toggleFeature(opt)} style={{ width: "16px", height: "16px", accentColor: "#00E5FF" }} />
                                <span style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: "14px", color: "#ffffff" }}>{opt}</span>
                              </label>
                            );
                          })}
                        </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                  <label style={{ display: "flex", alignItems: "flex-start", gap: "12px", cursor: "pointer", fontFamily: "'Space Grotesk',sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.78)" }}>
                    <input
                      type="checkbox"
                  ...
                  {errors.gdprConsent ? <span style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: "12px", color: "#FCA5A5", paddingLeft: "30px" }}>{errors.gdprConsent}</span> : null}
                </div>

                {submitError ? (
                  <p style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: "14px", color: "#FCA5A5", margin: 0 }} role="alert">
                    {submitError}
                  </p>
                ) : null}
