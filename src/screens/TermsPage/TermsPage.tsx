    ...
    <LandingStylePageRoot>
      ...
      <main className="relative" style={{ zIndex: 1, paddingTop: "100px", paddingBottom: "80px" }}>
        <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <h2 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 600, fontSize: "20px", marginTop: "32px", marginBottom: "12px" }}>{isEn ? "1. Scope of services" : "1. Rozsah služeb"}</h2>
          ...
          <h2 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 600, fontSize: "20px", marginTop: "32px", marginBottom: "12px" }}>{isEn ? "2. Intellectual property" : "2. Duševní vlastnictví"}</h2>
          <p style={{ fontFamily: "'Montserrat',sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: "16px" }}>
          ...
          <h2 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 600, fontSize: "20px", marginTop: "32px", marginBottom: "12px" }}>{isEn ? "3. Limitation of liability" : "3. Omezení odpovědnosti"}</h2>
          <p style={{ fontFamily: "'Montserrat',sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: "16px" }}>
          ...
          <h2 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 600, fontSize: "20px", marginTop: "32px", marginBottom: "12px" }}>{isEn ? "4. Governing law and place of performance" : "4. Rozhodné právo a místo plnění"}</h2>
          <p style={{ fontFamily: "'Montserrat',sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: "16px" }}>
          ...
          <h2 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 600, fontSize: "20px", marginTop: "32px", marginBottom: "12px" }}>{isEn ? "5. Dispute resolution" : "5. Řešení sporů"}</h2>
          <p style={{ fontFamily: "'Montserrat',sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: "16px" }}>
