    ...
    >
      ...
      <main className="relative" style={{ zIndex: 1, paddingTop: "100px", paddingBottom: "80px", backgroundColor: pk.page }}>
        <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <h2 style={h2Style}>{isEn ? "1. Scope of services" : "1. Rozsah služeb"}</h2>
          <p style={pStyle}>
          ...
          <h2 style={h2Style}>{isEn ? "2. Intellectual property" : "2. Duševní vlastnictví"}</h2>
          <p style={pStyle}>
          ...
          <h2 style={h2Style}>{isEn ? "3. Limitation of liability" : "3. Omezení odpovědnosti"}</h2>
          <p style={pStyle}>
          ...
          <h2 style={h2Style}>{isEn ? "4. Governing law and place of performance" : "4. Rozhodné právo a místo plnění"}</h2>
          <p style={pStyle}>
          ...
          <h2 style={h2Style}>{isEn ? "5. Dispute resolution" : "5. Řešení sporů"}</h2>
          <p style={pStyle}>
