    ...
    <LandingStylePageRoot>
      ...
      <main className="relative" style={{ zIndex: 1, paddingTop: "100px", paddingBottom: "80px" }}>
        <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 24px" }}>
          <h1 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 700, fontSize: "clamp(28px,4vw,40px)", marginBottom: "32px", letterSpacing: "-0.02em" }}>
            {isEn ? "Privacy Policy" : "Zásady ochrany soukromí"}
          </h1>
          <p style={{ fontFamily: "'Montserrat',sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: "24px" }}>
            {isEn
          ...
          <h2 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 600, fontSize: "20px", marginTop: "32px", marginBottom: "12px" }}>{isEn ? "1. What data we collect" : "1. Jaká data sbíráme"}</h2>
          <p style={{ fontFamily: "'Montserrat',sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: "16px" }}>
          ...
          <h2 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 600, fontSize: "20px", marginTop: "32px", marginBottom: "12px" }}>{isEn ? "2. Purpose of processing" : "2. Účel zpracování"}</h2>
          <p style={{ fontFamily: "'Montserrat',sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: "16px" }}>
          ...
          <h2 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 600, fontSize: "20px", marginTop: "32px", marginBottom: "12px" }}>{isEn ? "3. Cookies" : "3. Cookies"}</h2>
          <p style={{ fontFamily: "'Montserrat',sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: "16px" }}>
          ...
          <h2 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 600, fontSize: "20px", marginTop: "32px", marginBottom: "12px" }}>{isEn ? "4. Third parties" : "4. Třetí strany"}</h2>
          <p style={{ fontFamily: "'Montserrat',sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: "16px" }}>
          ...
          <h2 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 600, fontSize: "20px", marginTop: "32px", marginBottom: "12px" }}>{isEn ? "5. Your rights (GDPR)" : "5. Vaše práva (GDPR)"}</h2>
          <p style={{ fontFamily: "'Montserrat',sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: "16px" }}>
          ...
          <h2 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 600, fontSize: "20px", marginTop: "32px", marginBottom: "12px" }}>{isEn ? "6. Data controller and contact" : "6. Správce údajů a kontakt"}</h2>
          <p style={{ fontFamily: "'Montserrat',sans-serif", fontSize: "15px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, marginBottom: "16px" }}>
            {isEn
